...
$formu.="
	<table id='rounded-corner' >
		...
		<tr>
			<td colspan='2'>
				<input type='button' id='' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(100,$veh);UGO(\"idvel\",\"get\",\"\")'/>
				<input type='button' class='guardar1' id='' value='Guardar' onclick='xajax_auditabilidad(101,$veh);notifica_correo(\"vel\",$veh);UGO(\"idvel\",\"set\",\"E_vel\")'/>
			</td>
		</tr>
	</table><hr>";
$box='';
...
<table id='rounded-corner' >
	...
	<tr>
		<td colspan='2'>
			<input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(102,$veh);UGO(\"acel\",\"get\",\"\")'/>
			<input type='button' class='guardar1' value='Guardar' onclick='xajax_auditabilidad(103,$veh);notifica_correo(\"acel\",$veh);UGO(\"acel\",\"set\",\"aceleracion@desaceleracion\")'/>
		</td>
	</tr>
</table>
<hr>";
