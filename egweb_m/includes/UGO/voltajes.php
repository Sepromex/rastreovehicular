...
<table id='rounded-corner' >
	...
	<tr>
		<td colspan='2'>
			<input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(98,$veh);UGO(\"vext\",\"get\",\"\")'>
		</td>
	</tr>
</table><hr>";
...
<table id='rounded-corner' >
	...
	<tr>
		<td colspan='2'><input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(99,$veh);UGO(\"vbat\",\"get\",\"\")'></td>
	</tr>
</table><hr>";
?>