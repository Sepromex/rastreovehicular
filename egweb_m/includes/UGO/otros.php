...
<table id='rounded-corner'>
	...
	<tr>
		<td colspan='3'>
			<input type='button' class='agregar1' value='Obtener' onclick='xajax_auditabilidad(90,$veh);UGO(\"impact\",\"get\",\"\")'/>
			<input type='button' class='guardar1' value='Guardar' onclick='xajax_auditabilidad(91,$veh);notifica_correo(\"imp\",$veh);UGO(\"impact\",\"set\",\"fuerza\")'/>
		</td>
	</tr>
</table><hr>";
/*
...
<table id='rounded-corner'>
	...
	<tr>
		...
		<input type='button' class='guardar1' value='Obtener' onclick='xajax_auditabilidad(96,$veh);UGO(\"pdsr\",\"get\",\"\")'>
		<input type='button' class='guardar1' value='Guardar' onclick='xajax_auditabilidad(97,$veh);notifica_correo(\"pds\",$veh);
		UGO(\"pdsr\",\"set\",\"pdsr_mode@pdsr_time@pdsr_distancia@pdsr_grados\");
