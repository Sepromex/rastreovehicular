...
<table id='rounded-corner' >
	...
	<tr>
		<td>
			<input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(80,$veh);UCAN(\"odo\",\"get\",\"\")'>
		</td>
		<td>
			<input type='button' value='Guardar' class='guardar1' onclick='xajax_auditabilidad(81,$veh);UCAN(\"odo\",\"set\",\"odometro\")'>
		</td>
	</tr>
</table><hr>";
$box='';
...
<table id='rounded-corner' >
	...
	<tr>
		<td><input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(84,$veh);UCAN(\"inactivo\",\"get\",\"\")'></td>
		<td><input type='button' value='Guardar' class='guardar1' onclick='xajax_auditabilidad(85,$veh);notifica_correo(\"sin\",$veh);UCAN(\"inactivo\",\"set\",\"distSA@tiemSA\")'></td>
	</tr>
</table><hr>";
$box='';
$correos="SELECT folio FROM gpscondicionalerta where id_empresa=".$sess->get('Ide')." 
...
<table id='rounded-corner' >
	...
	<tr>
		<td><input type='button' value='Obtener'  class='agregar1' onclick='xajax_auditabilidad(86,$veh);UCAN(\"motion\",\"get\",\"\")'></td>
		<td><input type='button' value='Guardar'  class='guardar1' onclick='xajax_auditabilidad(87,$veh);notifica_correo(\"mov\",$veh);UCAN(\"motion\",\"set\",\"mfuer\");'></td>
	</tr>
</table><hr>";
?>