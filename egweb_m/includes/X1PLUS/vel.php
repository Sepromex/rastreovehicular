...
if(mysql_num_rows($query)==0){
	...
	<table id='rounded-corner' >
		...
		<tr>
			...
			<td>Desactivado<input type='radio' name='exceso' id='idvel2'></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan='2'>
				<input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(100,$veh);X1PLUS(\"idvel\",\"get\",\"\")'/>
				<input type='button' class='guardar1' value='Guardar' onclick='xajax_auditabilidad(101,$veh);notifica_correo(\"vel\",$veh);X1PLUS(\"idvel\",\"set\",\"E_vel\")'/>
			</td>
		</tr>
	</table><hr>";
}
