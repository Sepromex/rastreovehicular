...
<table id='rounded-corner' >
	...
	<tr>
		<td colspan='2'>
			<input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(100,$veh);U1PRO(\"idvel\",\"get\",\"\")'/>
			<input type='button' value='Guardar' class='guardar1' onclick='xajax_auditabilidad(101,$veh);notifica_correo(\"vel\",$veh);U1PRO(\"idvel\",\"set\",\"E_vel\")'/>
		</td>
	</tr>
</table><hr>";
}
...
<table id='rounded-corner' >
	...
	<tr>
		<td colspan='2'>
			<input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(102,$veh);U1PRO(\"acel\",\"get\",\"\")'/>
			<input type='button' value='Guardar' class='guardar1' onclick='xajax_auditabilidad(103,$veh);notifica_correo(\"acel\",$veh);U1PRO(\"acel\",\"set\",\"aceleracion@desaceleracion\")'/>
		</td>
	</tr>
</table>
<hr>";
