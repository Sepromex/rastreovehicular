...
<table id='rounded-corner'>
	$box
	<tr>
		<th width='320' colspan='2'  style='text-align:left'><b>Sensor de impacto</b>&nbsp;</th>
	...
	<tr>
		<td colspan='3'>
			<input type='button' class='agregar1'  id='bosi' value='Obtener' onclick='xajax_auditabilidad(90,$veh);U1PRO(\"impact\",\"get\",\"\")'/>
			<input type='button' id='besi' class='guardar1' value='Guardar' onclick='xajax_auditabilidad(91,$veh);notifica_correo(\"imp\",$veh);U1PRO(\"impact\",\"set\",\"fuerza\");i'/>
		</td>
	</tr>
</table><hr>";
...
$btn_info="<img style='float:right;cursor:pointer;' src='img/info.png' onclick='xajax_info(\"voz\")'>";
$formu.="
<table id='rounded-corner'>
	<tr>
	...
	<tr>
		<td colspan='2'><input type='button' class='agregar1' onclick='xajax_auditabilidad(124,$veh);U1PRO(\"llamar\",\"set\",\"numero\")' value='Enviar'></td>
	</tr>
</table><hr>";
}
/*
...
<table id='rounded-corner'>
	...
	<tr>
		<td>
			<input type='button' onclick='xajax_auditabilidad(92,$veh);xajax_obten_motor(".$veh.");xajax_horas_motor(".$veh.")' value='Obtener' class='agregar1'>
		</td>
		<td>
...
<table id='rounded-corner'>
	...
	<tr>
		...
		<input type='button' class='guardar1' value='Obtener' onclick='xajax_auditabilidad(97,$veh);U1PRO(\"pdsr\",\"get\",\"\")'>
		<input type='button' class='guardar1' value='Guardar' onclick='xajax_auditabilidad(96,$veh);notifica_correo(\"pds\",$veh);
		U1PRO(\"pdsr\",\"set\",\"pdsr_mode@pdsr_time@pdsr_distancia@pdsr_grados\");
...
if(mysql_num_rows($query_t)!=0){
	...
	if(mysql_num_rows($res)>0){
		if(mysql_num_rows($res)==1){
			...
			<tr>
				<th colspan='2' align='right'>
				<input type='radio' id='enviar_correo_tmp' onclick='xajax_mostrar_correo($folios[0],\"a_temp\")'>Notificar por correo
				</th>
			</tr>";
		}
		if(mysql_num_rows($res)>1){		
			...
			<tr>
				<th colspan='2' align='right'>
					<input type='radio' id='enviar_correo_tmp' onclick='xajax_mostrar_select(".$sess->get('Ide').",\"a_temp\")'>Notificar por correo
				</th>
			</tr>";		
		}
	}
		...
		<tr>
			<th colspan='2' align='right'>
			<input type='radio' id='enviar_correo_tmp' onclick='xajax_mostrar_nuevo(".$sess->get('Ide').",\"a_temp\")'>Notificar por correo</th>
		</tr>";
	}
	$btn_info="<img style='float:right;cursor:pointer;' src='img/info.png' onclick='xajax_info(\"a_temp\")'>";
	$formu.="
	<table id='rounded-corner' >
		$box
		<tr>
			<th>Temperatura</th>
			<th><div id='temp'></div>$btn_info</th>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td colspan='2'>
				...
				<input type='button' value='Guardar' class='guardar1' onclick='xajax_auditabilidad(89,$veh);notifica_correo(\"tmp\",$veh);U1PRO(\"temp\",\"set\",\"sensor@rango@minima@maxima@tiempo\");'>
			</td>
		</tr>
	</table><hr>";
}
