...
<table id='rounded-corner' >
	...
	<tr>
		<td colspan='2'>
			<input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(98,$veh);U1LITE(\"vext\",\"get\",\"\")'>
		</td>
	</tr>
</table><hr>";
...
<table id='rounded-corner' >
	...
	<tr>
		<td colspan='2'>
			<input type='button' value='Obtener' class='agregar1' onclick='xajax_auditabilidad(99,$veh);U1LITE(\"vbat\",\"get\",\"\")'>
		</td>
	</tr>
</table><hr>";
?>