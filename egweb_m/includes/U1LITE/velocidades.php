...
$formu.="
	<table id='rounded-corner' >
		...
		<tr>
			<td colspan='2'>
				<input type='button' id='' value='Obtener Velocidad' class='agregar1' onclick='U1LITE(\"idvel\",\"get\",\"\")'/>
				<input type='button' class='guardar1' id='' value='Enviar Velocidad' onclick='U1LITE(\"idvel\",\"set\",\"E_vel\")'/>
			</td>
		</tr>
	</table><hr>";
}
...
<table id='rounded-corner' >
	...
	<tr>
		<td colspan='2'>
			<input type='button' value='Obtener Aceleracion' class='agregar1' onclick='U1LITE(\"acel\",\"get\",\"\")'/>
			<input type='button' class='guardar1' value='Enviar Aceleracion' onclick='U1LITE(\"acel\",\"set\",\"aceleracion@desaceleracion\");acelera_correo();'/>
		</td>
...
<table id='rounded-corner' >
	...
	<tr>
		<td>
			<input type='button' value='Obtener Od&oacute;metro' class='agregar1' onclick='U1LITE(\"odo\",\"get\",\"\")'>
		</td>
		<td>
			<input type='button' value='Guardar Od&oacute;metro' class='guardar1' onclick='U1LITE(\"odo\",\"set\",\"odometro\")'>
		</td>
	</tr>
</table><hr>";
?>