...
<title>Empresa</title>
 <?php if($dis == 1){ ?>
    ...
    <?php }?>
<link rel="stylesheet" media="screen" type="text/css" href="datetimepicker/layout.css" />
<link rel="stylesheet" media="screen" type="text/css" href="datetimepicker/css/ui-lightness/jquery-ui-1.8.13.custom.css" />
<style type="text/css">
...
<script type="text/javascript" src="../fact/calendario/calendario.js"></script>
<link rel="stylesheet" type="text/css" href="flexigrid/css/flexigrid.pack.css" />
<script type="text/javascript" src="flexigrid/js/jquery-1.5.2.min.js"></script>
<script type="text/javascript" src="flexigrid/js/flexigrid.js"></script>
<script type='text/javascript' src="datetimepicker/js/jquery-ui-1.8.7.custom.min.js"></script>
<script type='text/javascript' src="datetimepicker/js/jquery-ui-timepicker-addon.js"></script>
<script language="JavaScript" type="text/javascript">

var camposReporte = new Array();
function ayuda(){
...
function cachaValores(cid,visible){
	camposReporte[cid]=visible;
}

function creaFlexiGrid(_query){
var query=document.getElementById("respQuery").value;

	$('.flexme1').flexigrid({
		height: 430,
		onToggleCol: cachaValores,
		colModel : [
			{display: 'NOMBRE',width : 209,sortable : false, align: 'center'},
			{display: 'PUESTO',width : 121,sortable : false, align: 'center'},
			{display: 'TELÉFONO',width : 135,sortable : false, align: 'center'},
			{display: 'CORREO',width : 105,sortable : false, align: 'center'},
			{display: 'HORARIO',width : 78,sortable : false, align: 'center'},
...
?>
<body id="fondo" onload="tiempo(<?php echo (int)$idu ?>,<?php echo $pan ?>);creaFlexiGrid();">
<center>
  ...
  <div id="emp1">
	...
	echo "<table width='802' border='0' ><tr><td colspan='5' align='right'><input type='hidden' id='respQuery' value='$cad_con'></td></tr></table>";
	?>
	<div style="position:absolute;width:802px;top:0px;left:30px" >
	  <table width="802" border="0" >
        <tr>
          <td  align="right">
          <?php if($est!=3){ ?>
          	<a href="javascript:void(null);" onclick="modContacto(0,0)">
            <img src="img/agregar1.png"  align="right" title="Agregar Contacto" width="20" height="20" border="0" title="Agregar contacto"/>
            </a>
          <?php }?>
         CONTACTOS</td>
        </tr></table>
	</div>
	<div id="respuesta2x" style="position:absolute;top:50px;width:788px;height:180px;left:30px;overflow:auto;">
	  <table class='flexme1' style='display: none' border="0" >
        <?php 
		
			while($rowCon = mysql_fetch_row($res_con)){
		  echo "<tr>";
		  echo "<td width='209'>".$rowCon[0]."</td>";
          echo "<td width='121'>".$rowCon[1]."</td>";
          echo "<td width='135'>".$rowCon[2]."</td>";
          echo "<td width='105'>".$rowCon[3]."</td>";
          echo "<td width='78'>".$rowCon[4]."</td>";
          echo "<td width='50'>";
		  if($est != 3){
			  echo "<a href='javascript:void(null);' onclick='modContacto($rowCon[5],1);' title='Editar contacto'>";
			  echo "<img src='img/kedit.png' width='15' height='15' border='0'></a>";
			  echo "<a href='javascript:void(null);' onclick='eliCont($rowCon[5]);' title='Eliminar contacto'>";
			  echo "<img src='img/ico_delete.png' width='15' height='15' border='0'></a>";
