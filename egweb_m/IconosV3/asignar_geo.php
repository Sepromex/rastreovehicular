...
$xajax->processRequest();
  ...
  //Seleccionar geocercas X empresa
  $idee=$ide;
...
function deselec_geos(){//Funcion que permite deseleccionar todos los checkbox   
     form = document.forms["frmasiggeo"];
...
<body id="fondo" onload="tiempo(<?php echo (int)$idu ?>);" >
	    ...
	    <select multiple name="vehiculos1[]" size="30" class="vehiculos" title="Presione CTRL+Click para seleccionar varios elementos">
	     ...
	     <div id="bot_asig">
           ...
           <img src="Iconos1/apply.png" title="Selecciona todos los vehículos" name="imgveh" width="17" height="16" onClick="seleccionar_veh();">Todos los Vehículos </label>
	        <label>
		     <br>
	         <img src="Iconos1/cancel1.jpg" name="imgcancelargeos" width="25" title="Cancelar" height="22" onClick="deselec_geos();" style="visibility:hidden">
             <img src="Iconos1/apply.png" title="Selecciona todas las Geocercas" name="imggeo" width="17" height="16" onClick="seleccionar_geos();">Todas las geocercas<br />
             <br>
	        </label>
            <input type="checkbox" name='panico' id="panico" value="2" checked="checked"/> 
            Aviso de Pánico a Monitoreo<br />
            <input type="checkbox" name='sale' id="sale" value="1" checked="checked" /> 
            Avisar al Salir<br />
