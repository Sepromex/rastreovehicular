...
<div id="fondo_principal_index">
        ...
        <tr>
          ...
          <td><label>
            <div style="position:relative;left:15px;">
			  ...
			  <input name="button" type="button" id="button2" value="Anterior" onclick="window.location.href='../EGWeb_Vieja/'" class="boton_x"/>
              </div>
          </label></td>
        </tr>
        <tr>
    ...
    <div id="contacto_index">Si tiene dudas, comentarios o sugerencias llámenos al (33) 3825 5200 ext. 104 , o bien envíe un email a 
		<a href="mailto:coord_monitoreo@sepromex.com.mx">coord_monitoreo@sepromex.com.mx</a>
	</div>
</div>
<script>
