<?php 
	...
	if ($detect->isMobile()) {
		//header("Location: ../movil/mobilex.php");			//habilitar para los moviles
	}
	...
	function Login($aFormValues){
		...
		if ($existe) {
			 ...
			 $db->Execute("insert into eventos values('$idu','0','".date("Y-m-d H:i:s")."','Entrada a EGWeb Nueva Mobil','10','".get_real_ip()."')");
