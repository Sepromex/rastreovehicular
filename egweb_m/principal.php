<?php
/*
if ($_SERVER['SERVER_ADDR'] != '10.0.0.2') {
	exit("EN MANTENIMIENTO, INTENTE DE NUEVO EN UNOS MINUTOS.");
}
...
function posicion($aFormValues){
	...
	if($aFormValues!=0){
		...
		if((($lat != "") || ($lon != "")) && (($lat != 0) || ($lon != 0))){
			...
			$objResponse->call("MapaCord", $lat, $lon, $tipov, $v);
			//DAVID
...
<head>
	...
	<script type="text/javascript"src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDEF3E6KJ0I25ueSeC2e5noNgJ6bj2yGkA" ></script>
		AIzaSyA2ZgtqdFwl6hQomaR295YK0A1XVjcVXl0

	AIzaSyDbr1ZoDby1GW6nP7RAgokJLqWP_95d6SE-->
