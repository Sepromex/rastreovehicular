    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Morris Chart</h4></div>
    ...
    <div class="row">
        <div class="col-12 col-md-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">                                   
                    <div dir="ltr" id="morris-area-chart"></div>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">                                        
                    <div dir="ltr" id="morris-area-chart2"></div>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">                                      
                    <div dir="ltr" id="extra-area-chart"></div>
                </div>
            </div>
        </div>                    
        <div class="col-12 col-md-6 mt-3">
        ...
        <div class="col-12 col-md-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">                                      
                    <div dir="ltr" id="donut-graph"></div>
                </div>
            </div>
        </div>                    
        <div class="col-12 col-md-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">                                      
                    <div dir="ltr" id="reload-graph"></div>
                </div>
            </div>
        </div>                    
    </div>
