    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><span class="h4 my-auto">User Profile</span></div>
        ...
        <div class="col-xl-3">
            <div class="card">
                ...
                <div class="card-body p-0">                               
                    <ul class="nav flex-column chat-menu p-0">
                ...
                <div class="card-body">
                    <form>
                        <div class="form-group mb-0">
                            ...
                            <ul class="list-inline mb-0 pt-3 bg-light p-3 border  border-top-0 d-flex justify-content-between align-items-center pr-0">
                                ...
                                <li class="list-inline-item mr-auto"><a href="#" class="btn btn-primary btn-xs text-uppercase">Post</a></li>
                            </ul>
                        </div>
                    </form>
                    <div class="row mt-4 portfolio-box">
                            ...
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author.jpg');?>" alt="" class="img-fluid rounded-circle d-flex ml-3"></a>
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author.jpg');?>" width="30" alt="" class="img-fluid d-flex ml-2 mt-1"></a>
                                        <div class="media-body">
                                    ...
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author1.jpg');?>" width="30" alt="" class="img-fluid d-flex ml-2 mt-1"></a>
                                        <div class="media-body">
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author1.jpg');?>" alt="" class="img-fluid rounded-circle d-flex ml-3" width="50"></a>
                                        <div class="media-body">
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author2.jpg');?>" width="30" alt="" class="img-fluid d-flex ml-2 mt-1"></a>
                                        <div class="media-body">
                                            <small><a href="#" class="text-primary font-weight-bold">Ruby Dixon</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula.</small>
                                            <small class="d-block"><a href="#" class="text-primary font-weight-bold">Like</a>. 
                                                <a href="#" class="text-primary font-weight-bold">Reply <sup>.</sup></a> 
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author3.jpg');?>" alt="" class="img-fluid rounded-circle d-flex ml-3" width="50"></a>
                                        <div class="media-body">
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author4.jpg');?>" width="30" alt="" class="img-fluid d-flex ml-2 mt-1"></a>
                                        <div class="media-body">
                                            <small><a href="#" class="text-primary font-weight-bold">Ruby Dixon</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula.</small>
                                            <small class="d-block"><a href="#" class="text-primary font-weight-bold">Like</a>. 
                                                <a href="#" class="text-primary font-weight-bold">Reply <sup>.</sup></a> 
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author8.jpg');?>" alt="" class="img-fluid rounded-circle d-flex ml-3" width="50"></a>
                                        <div class="media-body">
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author6.jpg');?>" width="30" alt="" class="img-fluid d-flex ml-2 mt-1"></a>
                                        <div class="media-body">
                                            <small><a href="#" class="text-primary font-weight-bold">Ruby Dixon</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula.</small>
                                            <small class="d-block"><a href="#" class="text-primary font-weight-bold">Like</a>. 
                                                <a href="#" class="text-primary font-weight-bold">Reply <sup>.</sup></a> 
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author7.jpg');?>" alt="" class="img-fluid rounded-circle d-flex ml-3" width="50"></a>
                                        <div class="media-body">
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author8.jpg');?>" width="30" alt="" class="img-fluid d-flex ml-2 mt-1"></a>
                                        <div class="media-body">
                                            <small><a href="#" class="text-primary font-weight-bold">Ruby Dixon</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula.</small>
                                            <small class="d-block"><a href="#" class="text-primary font-weight-bold">Like</a>. 
                                                <a href="#" class="text-primary font-weight-bold">Reply <sup>.</sup></a> 
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="<?php echo base_url('dist/images/author9.jpg');?>" alt="" class="img-fluid rounded-circle d-flex ml-3" width="50"></a>
                                        <div class="media-body">
