    ...
    <div class="row">
        <div class="col-12 align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Checkout</h4></div>
                    ...
                    <div class="wizard mb-4">                                            
                        ...
                        <ul class="nav nav-tabs d-flex mb-3">
                            <li class="nav-item mr-auto">
                                <a class="nav-link position-relative round-tab text-left text-sm-center p-0 active border-0" data-toggle="tab" href="#id1"> 
                                ...
                                <div class="form">
                                    <div class="row">
                                        <div class="col-lg-12 col-xl-7 mb-4 mb-xl-0">
                                            ...
                                            <div class="clearfix mt-4 float-right d-flex">
