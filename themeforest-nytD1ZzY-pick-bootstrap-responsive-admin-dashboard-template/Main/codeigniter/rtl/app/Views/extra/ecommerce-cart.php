    ...
    <div class="row">
        <div class="col-12 align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Cart</h4></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-xl-5">
                            ...
                            <div class="clearfix d-sm-flex">
                                <div class="float-right w-100 text-center text-sm-right mb-3">
                                    <a href="#" class="btn btn-primary">Process To Checkout</a>
                                </div>
                                <div class="float-left w-100 text-center text-sm-left">
