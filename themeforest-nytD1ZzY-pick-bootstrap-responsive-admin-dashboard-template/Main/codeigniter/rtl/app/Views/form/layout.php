    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Form Layouts</h4></div>
                                ...
                                <form>
                                        ...
                                        <div class="col-sm-10">  
                                            <div class="input-group mb-3">   
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-transparent" id="basic-addon11"><i class="icon-user"></i></span>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">  
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-transparent" id="basic-email1"><i class="icon-envelope"></i></span>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">  
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-transparent" id="basic-password1"><i class="icon-options"></i></span>
                                                </div>
                            ...
                            <div class="col-12">
                                <form>
                                    ...
                                    <div class="input-group  mb-3">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent" id="basic-addon1"><i class="icon-user"></i></span>
                                        </div>
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent" id="basic-email"><i class="icon-envelope"></i></span>
                                        </div>
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-transparent" id="basic-password"><i class="icon-options"></i></span>
                                        </div>
