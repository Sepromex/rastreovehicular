    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Form Elements</h4></div>
                    ...
                    <div class="card-body py-5">
                        <form  class="form-row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <div class="input-group mb-3"> 
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-transparent" id="basic-email3"><i class="icon-envelope"></i></span>
                                    </div>
                                    <input type="email" class="form-control rounded-0" placeholder="Email" aria-label="Email" aria-describedby="basic-email3">
                                    <div class="input-group-append">
                                        <span class="input-group-text bg-transparent" id="basic-email2"><i class="icon-envelope"></i></span>
                                    </div>
                                </div>
                            </div>
