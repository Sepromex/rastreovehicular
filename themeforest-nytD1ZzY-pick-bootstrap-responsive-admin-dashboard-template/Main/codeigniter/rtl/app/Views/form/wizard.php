...
<div class="row ">
    <div class="col-12  align-self-center">
        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
            <div class="w-sm-100 ml-auto"><h4 class="mb-0">Form Wizard</h4></div>
            ...
            <div class="row">
                                    ...
                                    <div class="tab-pane fade" id="id2">
                                        <div class="form">                                                   
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <button type="button" class="btn btn-primary nexttab mr-auto">Next</button>
                                    ...
                                    <div class="tab-pane fade" id="id5">
                                        <div class="form">                                                   
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <button type="button" class="btn btn-light nexttab mr-auto">Next</button>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="tab2">
                                    <div class="form">                                                   
                                        ...
                                        <div class="d-flex">
                                            <button type="button" class="btn btn-primary prevtab">Previous</button>
                                            <button type="button" class="btn btn-primary nexttab m2-auto">Next</button>
                ...
                <div class="col-12 col-md-6 mt-3">
                    <div class="card bg-primary">
                        <div class="card-body wizard-dark">
                            ...
                            <ul class="nav nav-tabs d-block d-sm-flex mb-4 pr-0">
                                <li class="nav-item ml-auto mb-4">
                ...
                <div class="col-12 col-md-6 mt-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="row p-3">
                                <ul class="col-sm-4 nav nav-tabs d-block d-sm-flex mb-4 pr-0">
                                    <li class="nav-item  mb-4">
                ...
                <div class="col-12 col-md-6 mt-3">
                    <div class="card bg-primary">
                        <div class="card-body wizard-dark">
                            <div class="row p-3">
                                <ul class="col-sm-4 nav nav-tabs d-block d-sm-flex mb-4">
                                    <li class="nav-item  mb-4">
                                ...
                                <div class="tab-content col-sm-8  text-white">
