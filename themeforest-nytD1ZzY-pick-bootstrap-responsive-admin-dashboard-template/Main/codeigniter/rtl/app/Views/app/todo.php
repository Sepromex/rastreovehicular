    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">App To Do</h4></div>
        ...
        <div class="col-12 col-lg-2 mt-3 todo-menu-bar flip-menu pl-lg-0">
            ...
            <div class="card border h-100 todo-menu-section">
                <div class="card-header d-flex justify-content-between align-items-center">  
                    ...
                    <a href="#"  class="bg-primary py-2 px-2 rounded mr-auto text-white" data-toggle="modal" data-target="#newtodo">
