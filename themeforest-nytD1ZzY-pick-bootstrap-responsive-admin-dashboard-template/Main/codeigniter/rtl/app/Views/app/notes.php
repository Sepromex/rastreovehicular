...
<!-- START: Breadcrumbs-->
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">App Notes</h4></div>
    ...
    <div class="row">
        <div class="col-12 col-lg-3 col-xl-2 mb-4 mt-3 pl-lg-0 flip-menu">
            ...
            <div class="card border h-100 notes-menu-section ">
                ...
                <ul class="list-unstyled inbox-nav  mb-0 mt-2 notes-menu pr-0">
                ...
                <ul class="nav flex-column font-weight-bold mt-3 note-label pr-0" id="myTab1" role="tablist">
