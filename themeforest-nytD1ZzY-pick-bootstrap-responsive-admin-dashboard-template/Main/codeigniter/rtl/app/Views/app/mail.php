...
<!-- START: Breadcrumbs-->
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">App Mail</h4></div>
    ...
    <!-- START: Card Data-->
    <div class="row">
        <div class="col-12 col-lg-3 col-xl-2 mb-4 mt-3 pl-lg-0 flip-menu">
            ...
            <div class="card border h-100 mail-menu-section ">
                ...
                <ul class="list-unstyled inbox-nav  mb-0 mt-2 mail-menu pr-0">
                    <li class="nav-item"><a href="#" data-mailtype="inbox" class="nav-link active"><i class="icon-envelope pl-2"></i> Inbox <span class="mr-auto badge badge-pill badge-success bg-success">8</span></a></li>
                    <li class="nav-item"><a href="#" data-mailtype="sent" class="nav-link"><i class="icon-paper-plane pl-2"></i> Send Mail</a></li>
                    <li class="nav-item"><a href="#" data-mailtype="draft" class="nav-link"><i class="icon-pencil pl-2"></i> Draft</a></li>
                    <li class="nav-item"><a href="#" data-mailtype="archive" class="nav-link"><i class="icon-folder-alt pl-2"></i> Archive</a></li>
                    <li class="nav-item"><a href="#" data-mailtype="trash" class="nav-link"><i class="icon-trash pl-2"></i> Trash</a></li>
                </ul>
                <div class="eagle-divider"></div>
                <div class="card-header py-1 mt-4">                                 
                    <h6 class="mb-0">Labels</h6>
                </div>
                <ul class="nav flex-column font-weight-bold mt-3 mail-label pr-0" id="myTab1" role="tablist">
                    <li class="nav-item  px-3">
                        <a class="nav-link text-primary" data-label="business-mail" href="#" >
                            Business <i class="icon-pin"></i>
                        </a>
                    </li>
                    <li class="nav-item  px-3">
                        <a class="nav-link text-danger" data-label="private-mail" href="#" >
                            Private <i class="icon-pin"></i>
                        </a>
                    </li>
                    <li class="nav-item  px-3">
                        <a class="nav-link text-warning" data-label="social-mail" href="#">
                            Social <i class="icon-pin"></i>
                        </a>
                    </li>
                    <li class="nav-item  px-3 ">
                        <a class="nav-link text-success" data-label="personal-mail" href="#">
                            Personal <i class="icon-pin"></i>
                        </a>
                    </li>
                    <li class="nav-item px-3 ">
                        <a class="nav-link text-info" data-label="work-mail" href="#">
                            Work <i class="icon-pin"></i>
                        </a>
                    </li>
        ...
        <div class="col-12 col-lg-9 col-xl-10 mb-4 mt-3 pr-lg-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="media mb-5 mt-5">
                            <div class="align-self-center">
                                <img src="dist/images/author1.jpg" alt="" class="img-fluid rounded-circle d-flex ml-3" width="40">
                            </div>
                ...
                <div class="card-body p-0">
                    <div class="row m-0 border-bottom theme-border">
                        <div class="col-12 px-2 py-3 d-flex mail-toolbar">
                            <div class="check d-inline-block ml-3">
                            ...
                            <div>
                                <a href="#" class="ml-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-right mail-bulk-action">
                                    <a class="dropdown-item mailread" href="#" >Mark as Read <i class="icon-book-open"></i></a>
                                    <a class="dropdown-item mailunread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                                    <a class="dropdown-item delete" href="#">Delete <i class="icon-trash"></i></a>                                        
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="scrollertodo">
                        <ul class="mail-app list-unstyled pr-0">
                                ...
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        <span class="mail-type-icon">
                                            <i class="icon-star ml-2"></i> 
                                            <i class="icon-exclamation ml-1"></i>
                                        </span>
                                        <span class="mail-user">Nathan S. Johnson</span> 
                                        <p class="mail-subject">Aenean ligula porttitor consequat vitae eleifend enim.</p>                                               
                                        <div class="d-flex mt-3 mt-md-0 mr-auto">
                                            <div class="pill-link"> <i class="icon-link ml-3"></i> </div>
                                            <div class="mr-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">June 15 at 07:10am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                                                <a class="dropdown-item single-delete" href="#">Delete <i class="icon-trash"></i></a>                                        
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="py-3 px-2 mail-item inbox starred private-mail">
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <div class="d-flex mt-3 mt-md-0 mr-auto">
                                            <div class="mr-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">June 8 at 07:10am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                                ...
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <div class="d-flex mt-3 mt-md-0 mr-auto">
                                            <div class="pill-link"> <i class="icon-link ml-3"></i> </div>
                                            <div class="mr-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">June 7 at 17:10am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                            ...
                            <li class="py-3 px-2 mail-item inbox unread starred business-mail">
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <div class="d-flex mt-3 mt-md-0 mr-auto">                                                       
                                            <div class="mr-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">June 6 at 08:15am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                            ...
                            <li class="py-3 px-2 mail-item inbox important work-mail">
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <div class="d-flex mt-3 mt-md-0 mr-auto">                                                       
                                            <div class="mr-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">May 16 at 07:33am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                                ...
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <div class="d-flex mt-3 mt-md-0 mr-auto">  
                                            ...
                                            <p class="mr-auto mail-date mb-0">May 14 at 09:23am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                            ...
                            <li class="py-3 px-2 mail-item inbox starred important personal-mail">
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <div class="d-flex mt-3 mt-md-0 mr-auto"> 
                                            <div class="mr-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">May 12 at 09:23am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                            ...
                            <li class="py-3 px-2 mail-item inbox important">
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <div class="d-flex mt-3 mt-md-0 mr-auto"> 
                                            <div class="mr-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">May 11 at 09:23am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                            ...
                            <li class="py-3 px-2 mail-item inbox starred work-mail">
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <div class="d-flex mt-3 mt-md-0 mr-auto"> 
                                            <div class="mr-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">May 10 at 19:43am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                                                <a class="dropdown-item single-unread" href="#">Mark as unread <i class="icon-notebook"></i></a>
                            ...
                            <li class="py-3 px-2 mail-item sent important">
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <p class="mail-subject">Aenean ligula porttitor consequat vitae eleifend enim.</p>                                               
                                        <div class="d-flex mt-3 mt-md-0 mr-auto">
                                            <div class="mr-md-auto mr-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">May 12 at 09:23am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
                            ...
                            <li class="py-3 px-2 mail-item trash starred">
                                <div class="d-flex align-self-center align-middle">
                                    ...
                                    <div class="mail-content d-md-flex w-100">
                                        ...
                                        <p class="mail-subject">4 questions answered about business</p>                                               
                                        <div class="d-flex mt-3 mt-md-0 mr-auto">
                                            <div class="ml-md-auto ml-3 dot primary"></div>
                                            <p class="mr-auto mail-date mb-0">May 12 at 09:23am</p>
                                            <a href="#" class="mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></a>
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                <a class="dropdown-item single-read" href="#" >Mark as Read <i class="icon-book-open"></i> </a>
