    ...
    <div class="row">
        <div class="col-12 align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">App Calendar</h4></div>
        ...
        <div class="col-12 col-md-12 mt-3">  
            <div class="card">
                <div class="card-body d-md-flex text-center">
                    <ul class="d-md-flex m-0 pl-0 list-unstyled pr-0">
                    ...
                    <a href="#" class="btn btn-outline-success font-w-600 my-auto text-nowrap mr-auto add-event" data-toggle="modal" data-target="#addevent"><i class="icon-calendar"></i> Add Event</a>
