...
<!-- START: Breadcrumbs-->
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">App Contact List</h4></div>
    ...
    <div class="row row-eq-height">
        <div class="col-12 col-lg-2 mt-3 todo-menu-bar flip-menu pl-lg-0">
            ...
            <div class="card border h-100 contact-menu-section">
                <div class="card-header d-flex justify-content-between align-items-center"> 
                    ...
                    <a href="#"  class="bg-primary py-2 px-2 rounded ml-auto text-white w-100 text-center" data-toggle="modal" data-target="#newcontact">
                        <i class="icon-plus align-middle text-white"></i> Add New Contact
                    </a>
                    <!-- Add Contact -->
        ...
        <div class="col-12 col-lg-10 mt-3 pr-lg-0">
            <div class="card border h-100 contact-list-section">
                <div class="card-header border-bottom p-1 d-flex">
                    ...
                    <a href="#" class="list-style search-bar-menu  active"><i class="icon-list"></i></a>
                    <a href="#" class="grid-style search-bar-menu border-0"><i class="icon-grid"></i></a>
                </div>
