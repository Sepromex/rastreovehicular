    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Linear Icon</h4></div>

                <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                    <li class="breadcrumb-item">Home</li>
                    <li class="breadcrumb-item">Icon</li>
                    <li class="breadcrumb-item active"><a href="#">Linear Icon</a></li>
                </ol>
            </div>
        </div>
    </div>
...
<!-- START: Page CSS-->
<link rel="stylesheet"  href="<?php echo base_url('dist/vendors/linearicons/style.css'); ?>">
<!-- END: Page CSS-->
<?= $this->endSection() ?>
