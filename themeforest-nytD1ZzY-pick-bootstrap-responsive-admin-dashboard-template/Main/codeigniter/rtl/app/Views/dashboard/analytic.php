                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless pick-table mb-0">
                                            ...
                                            <tbody>
                                                <tr class="zoom">
                                                    <td>California</td>                                                   
                                                    <td class="text-left">80,200</td>
                                                </tr>
                                                <tr class="zoom">
                                                    <td>Texas</td>                                                  
                                                    <td class="text-left">78,410</td>
                                                </tr>
                                                <tr class="zoom">
                                                    <td>Wyoming</td>                                                   
                                                    <td class="text-left">162,050</td>
                                                </tr>
                                                <tr class="zoom">
                                                    <td>Florida</td>                                                   
                                                    <td class="text-left">187,792</td>
                                                </tr>
                                                <tr class="zoom">
                                                    <td>New York</td>                                                    
                                                    <td class="text-left">13,087</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <table class="table font-w-600 mb-0">
                                    ...
                                    <tbody>
                                        <tr class="zoom">                                           
                                            ...
                                            <td class="text-left"><div id="analitic_state1"></div></td>
                                        </tr>   
                                        <tr class="zoom">                                           
                                            <td>United States</td>
                                            ...
                                            <td class="text-danger">3,23,55,479 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            <td class="text-info">4,23,27,346</td>
                                            <td class="text-left"><div id="analitic_state2"></div></td>
                                        </tr> 
                                        <tr class="zoom">                                           
                                            <td>China</td>
                                            ...
                                            <td class="text-danger">3,23,55,479 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            <td class="text-info">4,23,27,346</td>
                                            <td class="text-left"><div id="analitic_state3"></div></td>
                                        </tr> 
                                        <tr class="zoom">                                           
                                            <td>Spain</td>
                                            ...
                                            <td class="text-danger">3,23,55,479 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            <td class="text-info">4,23,27,346</td>
                                            <td class="text-left"><div id="analitic_state4"></div></td>
                                        </tr> 
                                        <tr class="zoom">                                           
                                            <td>Italy</td>
                                            ...
                                            <td class="text-danger">3,23,55,479 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            <td class="text-info">4,23,27,346</td>
                                            <td class="text-left"><div id="analitic_state5"></div></td>
                                        </tr> 
                                        <tr class="zoom">                                           
                                            ...
                                            <td class="text-danger">3,23,55,479 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            <td class="text-info">4,23,27,346</td>
                                            <td class="text-left"><div id="analitic_state6"></div></td>
                                        </tr> 
                                        <tr class="zoom">                                           
                                            <td>Malaysia</td>
                                            ...
                                            <td class="text-danger">3,23,55,479 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            <td class="text-info">4,23,27,346</td>
                                            <td class="text-left"><div id="analitic_state7"></div></td>
                                        </tr> 
