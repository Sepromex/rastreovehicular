    ...
    <div class="row">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Dashboard</h4> <p>Welcome to liner admin panel</p></div>
                        ...
                        <div class="col-12 col-sm-6 mt-3">
                            <div class="card bg-primary">
                                <div class="card-body">
                                    ...
                                    <div id="apex_primary_chart" dir="ltr"></div>                               
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="apex_today_visitors" dir="ltr"></div> 
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6  mt-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="apex_today_sale" dir="ltr"></div> 
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="apex_today_profit" dir="ltr"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">                           
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div id="apex_bar_chart" dir="ltr" class="height-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-content">
                    <div class="card-body">  
                        <div class="d-flex"> 
                            ...
                            <div class="mr-auto border-0 outline-badge-warning circle-50"><span class="h5 mb-0">$</span></div>
                        </div>
                        <div id="flot-report" dir="ltr" class="height-175 w-100 mt-3"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-content">
                    <div class="card-body"> 
                        <div class="d-flex"> 
                            ...
                            <div class="mr-auto border-0 outline-badge-success circle-50"><span class="h5 mb-0">$</span></div>
                        </div>
                        <div class="d-flex mt-4">
                            <div class="border-0 outline-badge-info w-50 p-3 rounded text-center"><span class="h5 mb-0">Income</span><br/>                                        
                                $78,600
                            </div>
                            <div class="border-0 outline-badge-success w-50 p-3 rounded mr-2 text-center"><span class="h5 mb-0">Sales</span><br/>                                        
                                $1,24,600
                            </div>
                        </div>
                        ...
                        <div class="d-flex mt-3">
                            ...
                            <div class="border-0 outline-badge-danger w-50 p-3 rounded mr-2 text-center"><span class="h5 mb-0">Orders</span><br/>                                        
                                2,600
                            </div>
                        </div>
                ...
                <div class="card-content">
                    <div class="card-body">  
                        <div class="height-235">
                            <canvas id="chartjs-other-pie" dir="ltr"></canvas>
                        </div>
                ...
                <div class="card-content border-bottom border-warning border-w-5">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex">
                            ...
                            <img src="dist/images/author9.jpg" alt="author" width="30" class="rounded-circle  mr-auto">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card overflow-hidden">
                ...
                <div class="card-content">
                    <div class="card-body p-0">
                        <ul class="list-group list-unstyled pr-0">
                                ...
                                <ul class="tasks pr-0">
                                    <li class="outline-badge-success border-0 d-flex py-3 px-2 zoom">
                                        <label class="chkbox d-flex">
                                            ...
                                            <span class="mb-0 mr-2 my-auto font-w-600">Aenean ligula porttitor consequat vitae eleifend enim.</span>

                                            <span class="checkmark mt-1"></span>
                                        </label>
                                        <div class="ml-auto d-flex my-auto"><a href="#"><i class="ion ion-edit"></i></a> <a href="#" class="mr-2"><i class="ion ion-trash-a"></i></a></div>
                                    </li>
                                    <li class="outline-badge-warning border-0 d-flex py-3 px-2 zoom">
                                        <label class="chkbox d-flex">
                                            ...
                                            <span class="mb-0 mr-2 my-auto font-w-600">In enim justo, rhoncus ut imperdiet a, venenatis vitae justo.</span>
                                    ...
                                    <li class="outline-badge-info border-0 d-flex py-3 px-2 zoom">
                                        <label class="chkbox d-flex">
                                            ...
                                            <span class="mb-0 mr-2 my-auto font-w-600">Cras dapibus vivamus elementum semper nisi.</span>
                                    ...
                                    <li class="outline-badge-secondary border-0 d-flex py-3 px-2 zoom">
                                        <label class="chkbox d-flex">
                                            ...
                                            <span class="mb-0 mr-2 my-auto font-w-600">Donec quam felis ultricies nec, pellentesque eu pretium quis.</span>
                        ...
                        <div class="row">                                           
                            <div class="col-12">
                                <ul class="activities mt-3 mb-2">
                                    <li class="activity py-2 border-right">
                                        <div class="activity-absolute">
                                            <div class="absolute-circle dropbox"><i class="fab fa-dropbox"></i></div>
                                            <img src="dist/images/author8.jpg" alt="author" width="50" class="rounded-circle position-absolute mr-35">
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <p class="mr-2">
                                                Liner Admin.psd<br>
                                                <a href="#" class="text-primary small">Download  <i class="fas   ml-2 fa-cloud-download-alt"></i></a>                                                                
                                            </p>
                                        </div>                                                         
                                    </li>
                                    <li class="activity py-3 border-right">
                                        <div class="activity-absolute">
                                            <div class="absolute-circle galleries"><i class="far fa-images"></i></div>
                                            <img src="dist/images/author6.jpg" alt="author" width="50" class="rounded-circle position-absolute mr-35">
                                        </div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <img src="dist/images/portfolio2.jpg" alt="photoshop" width="100" class="img-responsive rounded mr-2">
        ...
        <div class="col-12  col-md-6 col-lg-4 mt-3">
            ...
            <div class="card promoting-card">
                ...
                <div class="card-body d-flex flex-row">
                    ...
                    <!-- Avatar -->
                    <img src="dist/images/author1.jpg" class="rounded-circle ml-3" height="50" width="50" alt="avatar">
                ...
                <div class="card-body">
                    ...
                    <div class="collapse-content">
                        <a class="btn btn-flat font-w-600 float-left">Read More</a>
                        <i class="fas fa-share-alt text-muted float-right p-1 my-1" data-toggle="tooltip" data-placement="top" title="Share this post"></i>
                        <i class="fas fa-heart text-muted float-right p-1 my-1 ml-3" data-toggle="tooltip" data-placement="top" title="I like it"></i>
