                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless pick-table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>USA</td>
                                        <td class="text-left">964,817</td>
                                        <td class="text-left">72,275</td>
                                    </tr>
                                    <tr>
                                        <td>Canada</td>
                                        <td class="text-left">31,010</td>
                                        <td class="text-left">4,043</td>
                                    </tr>
                                    <tr>
                                        <td>Mexico</td>
                                        <td class="text-left">6,708</td>
                                        <td class="text-left">2,507</td>
                                    </tr>
                                    <tr>
                                        <td>Dominican Republic</td>
                                        <td class="text-left">6,221</td>
                                        <td class="text-left">354</td>
                                    </tr>
                                    <tr>
                                        <td>Panama</td>
                                        <td class="text-left">6,490</td>
                                        <td class="text-left">210</td>
                                    </tr>
                                    <tr>
                                        <td>Cuba</td>
                                        <td class="text-left">5,345</td>
                                        <td class="text-left">323</td>
                                    </tr>
                                    <tr>
                                        <td>Honduras</td>
                                        <td class="text-left">5,555</td>
                                        <td class="text-left">657</td>
                                    </tr>
                                    <tr>
                                        <td>Guatemala</td>
                                        <td class="text-left">6,490</td>
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-unstyled pr-0">
                            <li class="py-3 px-4 border-bottom zoom">                                           
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Fever <i class="fas fa-arrow-left mr-auto my-auto"></i></a> 
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">  
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Tiredness <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                             
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Dry Cough <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Aches and Pains <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Nasal Congestion <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Runny Nose <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
                            <li class="py-3 px-4 zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Sore Throat <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
            ...
            <div class="card overflow-hidden"> 
                ...
                <div class="card-content">
                    <div class="card-body p-0">
                        <ul class="list-group list-unstyled pr-0">
                            <li class="py-3 px-4 border-bottom zoom">                                           
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Stay home <i class="fas fa-arrow-left mr-auto my-auto"></i></a> 
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">  
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Keep a safe distance <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                             
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Wash hands often <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Cover your cough <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Sick? Call the helpline <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
                            <li class="py-3 px-4 border-bottom zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Cover your nose <i class="fas fa-arrow-right ml-auto my-auto"></i></a>                                                
                            </li>
                            <li class="py-3 px-4 zoom">      
                                <a href="#" class="mb-0 font-w-600 d-flex w-100 color-primary">Follow local health authority <i class="fas fa-arrow-left mr-auto my-auto"></i></a>                                                
                            </li>
