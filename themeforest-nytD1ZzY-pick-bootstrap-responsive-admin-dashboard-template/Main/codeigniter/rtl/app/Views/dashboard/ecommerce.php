        ...
        <div class="col-12 col-sm-6 col-xl-3 mt-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="apex_today_order" dir="ltr"></div>                               
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-xl-3 mt-3">
        ...
        <div class="col-12 col-lg-8  mt-3">
            <div class="card">                           
                <div class="card-content">
                    <div class="card-body">
                        <div id="apex_mixed_chart"  dir="ltr" class="height-500"></div>
                    </div>
                </div>
            </div>
        </div>     
                ...
                <div class="card-content">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex">
                            ...
                            <img src="dist/images/author2.jpg" alt="author" width="30" class="rounded-circle  mr-auto">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex">
                            ...
                            <img src="dist/images/author3.jpg" alt="author" width="30" class="rounded-circle  mr-auto">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex">
                            ...
                            <img src="dist/images/author7.jpg" alt="author" width="30" class="rounded-circle  mr-auto">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-borderless pick-table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-left">$80,200.70</td>
                                    </tr>
                                    <tr>
                                        <td>Texas</td>
                                        <td class="text-right">9,950</td>
                                        <td class="text-left">$78,410.30</td>
                                    </tr>
                                    <tr>
                                        <td>Wyoming</td>
                                        <td class="text-right">6,158</td>
                                        <td class="text-left">$162,050.20</td>
                                    </tr>
                                    <tr>
                                        <td>Florida</td>
                                        <td class="text-right">7,875</td>
                                        <td class="text-left">$187,792.10</td>
                                    </tr>
                                    <tr>
                                        <td>New York</td>
                                        <td class="text-right">12,560</td>
                                        <td class="text-left">$13,087.90</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
