    ...
    <div class="row">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 px-md-0 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Dashboard</h4> <p>Welcome to liner admin panel</p>
                        ...
                        <ul class="list-group list-unstyled pr-0">
                            <li class="p-4 border-bottom">
                                <div class="media d-flex w-100">
                                    ...
                                    <div class="mr-auto my-auto font-weight-bold">
                                        $12,456.00
                                    </div>
                                </div> 
                            </li> 
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless pick-table mb-2">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Bitcoin</td>                                                   
                                        <td class="text-left text-success">$80,200 <i class="ion ion-arrow-graph-up-right"></i></td>
                                    </tr>
                                    <tr>
                                        <td>Ethereum</td>                                                  
                                        <td class="text-left text-success">$78,410 <i class="ion ion-arrow-graph-up-right"></i></td>
                                    </tr>
                                    <tr>
                                        <td>XRP</td>                                                   
                                        <td class="text-left text-danger">$162,050 <i class="ion ion-arrow-graph-down-right"></i></td>
                                    </tr>
                                    <tr>
                                        <td>Tether</td>                                                   
                                        <td class="text-left text-success">$187,792 <i class="ion ion-arrow-graph-up-right"></i></td>
                                    </tr>
                                    <tr>
                                        <td>Litecoin</td>                                                    
                                        <td class="text-left text-danger">$13,087 <i class="ion ion-arrow-graph-down-right"></i></td>
                                    </tr>
                                    <tr>
                                        <td>Chainlink</td>                                                    
                                        <td class="text-left text-success">$23,087 <i class="ion ion-arrow-graph-up-right"></i></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="d-flex outline-badge-primary border-0">
                            <div class="w-50 text-center p-3 border-left"><a href="#" class="font-weight-bold">View Profile <i class="fas fa-arrow-right"></i></a></div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless pick-table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Jan</td>                                                   
                                                <td class="text-left text-success">$34,200 <i class="ion ion-arrow-graph-up-right"></i></td>
                                            </tr>
                                            <tr>
                                                <td>Fed</td>                                                  
                                                <td class="text-left text-success">$21,122 <i class="ion ion-arrow-graph-up-right"></i></td>
                                            </tr>
                                            <tr>
                                                <td>March</td>                                                   
                                                <td class="text-left text-danger">$12,456 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            </tr>
                                            <tr>
                                                <td>April</td>                                                   
                                                <td class="text-left text-success">$44,234 <i class="ion ion-arrow-graph-up-right"></i></td>
                                            </tr>
                                            <tr>
                                                <td>March</td>                                                    
                                                <td class="text-left text-danger">$77,765 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            </tr>
                                            <tr>
                                                <td>April</td>                                                    
                                                <td class="text-left text-success">$23,234 <i class="ion ion-arrow-graph-up-right"></i></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless pick-table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Jan</td>                                                   
                                                <td class="text-left text-success">$20,200 <i class="ion ion-arrow-graph-up-right"></i></td>
                                            </tr>
                                            <tr>
                                                <td>Fed</td>                                                  
                                                <td class="text-left text-success">$58,410 <i class="ion ion-arrow-graph-up-right"></i></td>
                                            </tr>
                                            <tr>
                                                <td>March</td>                                                   
                                                <td class="text-left text-danger">$152,050 <i class="ion ion-arrow-graph-down-right"></i></td>
                                            </tr>
                                            <tr>
                                                <td>April</td>                                                   
                                                <td class="text-left text-success">$187,792 <i class="ion ion-arrow-graph-up-right"></i></td>
