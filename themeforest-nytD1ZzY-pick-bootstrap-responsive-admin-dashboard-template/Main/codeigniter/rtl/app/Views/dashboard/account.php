                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8  col-lg-6 mt-3">
                                <canvas id="chartjs-account-chart" dir="ltr"></canvas>
                            </div>
                            <div class="col-12 col-md-4  col-lg-3 mt-3">
                                <div class="p-2">
                                    ...
                                    <div class="d-flex mt-4">
                                        ...
                                        <div class="border-0 outline-badge-success w-50 p-3 rounded mr-2 text-center"><span class="h6 mb-0">$1,24,600</span><br>
                                            Equity
                                        </div>
                                    </div>
                                    <div class="d-flex mt-3">
                                        ...
                                        <div class="border-0 outline-badge-danger w-50 p-3 rounded mr-2 text-center"><span class="h6 mb-0">$2,600</span><br>
                                            Real Estate
                                        </div>
                                    </div>
                                </div>
                        ...
                        <ul class="list-group list-unstyled pr-0">
                            <li class="p-2 border-bottom zoom">
                                <div class="media d-flex w-100">
                                    ...
                                    <div class="media-body align-self-center pr-4">
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body p-4 text-center">
                        ...
                        <ul class="list-inline my-3 pr-0">
                            <li class="list-inline-item m-0"><i class="fab fa-cc-mastercard h1 color-primary"></i></li>
                            <li class="list-inline-item m-1"><i class="fab fa-cc-visa h1 color-primary"></i></li>
                            <li class="list-inline-item m-0"><i class="fab fa-cc-paypal h1 color-primary"></i></li>
                        </ul>
                        ...
                        <ul class="list-group list-unstyled pr-0">
                            <li class="p-2 border-bottom zoom">
                                <div class="media d-flex w-100">
                                    ...
                                    <div class="ml-auto my-auto pr-4 font-weight-bold  text-right text-success">
                                        +500<br>
                                        <small class="d-block">USD</small>
                                    </div>
                                </div>
                            ...
                            <li class="p-2 border-bottom zoom">
                                <div class="transaction-date d-flex w-100">
                                    ...
                                    <div class="ml-auto my-auto pr-4 font-weight-bold text-right text-danger">
                                        -500<br>
                                        <small class="d-block">USD</small>
                                    </div>
                                </div>
