...
<!-- START: Breadcrumbs-->
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 ml-auto"><h4 class="mb-0">Jumbotron</h4></div>
    ...
    <div class="row">
            ...
            <div class="card border">                            
                <div class="card-content">
                    <div class="card-body p-4">   
                        <div class="d-md-flex">
                            <div class="my-auto">
                                <img src="<?php echo base_url('dist/images/wallet.png');?>" alt="author" width="48" class="my-auto">
                            </div>
            ...
            <div class="card outline-badge-primary">                            
                <div class="card-content">
                    <div class="card-body p-4">   
                        <div class="d-md-flex">
                            <div class="my-auto">
                                <img src="<?php echo base_url('dist/images/money.png');?>" alt="author" class="my-auto">
                            </div>
                            <div class="content px-md-3 my-3 my-md-0">                                           
                                <span class="mb-0 font-w-600 h5">Lorem ipsum dolor sit</span><br>
                                <p class="mb-0 font-w-500 tx-s-12">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis.</p>                                                    
        ...
        <div class="col-12 col-md-6 col-lg-6 mt-3">
            <div class="card outline-badge-secondary">                            
                <div class="card-content">
                    <div class="card-body p-4">   
                        <div class="d-md-flex">
                            <div class="my-auto">
        ...
        <div class="col-12 col-md-6 col-lg-6 mt-3">
            <div class="card outline-badge-warning">                            
                <div class="card-content">
                    <div class="card-body p-4">   
                        <div class="d-md-flex">
                            <div class="my-auto">
        ...
        <div class="col-12 col-md-6 col-lg-6 mt-3">
            <div class="card outline-badge-info">                            
                <div class="card-content">
                    <div class="card-body p-4">   
                        <div class="d-md-flex">
                            <div class="my-auto">
